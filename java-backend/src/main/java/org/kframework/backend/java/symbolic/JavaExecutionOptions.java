...
public final class JavaExecutionOptions {
    ...
    @Parameter(names={"--state-log-events"}, converter=LogEventConverter.class, description="Comma-separated list of events to log: [OPEN|REACHINIT|REACHTARGET|REACHPROVED|NODE|RULE|SRULE|RULEATTEMPT|RULEAPPLICATION|IMPLICATION|Z3QUERY|Z3RESULT|CLOSE]")
